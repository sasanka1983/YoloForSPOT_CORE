...
class JetsonYolo: 
	...
	def __init__(self, camera_source=0,image_path="/yolo_image_recognition",connection_string=""):
		...
		if not (connection_string=="" or connection_string==null or len(connection_string)<5):
				...
				while True:
					...
					if ret:
						...
						for obj in objs:
							...
							score = obj['score']
							if(score>.70):
								print(f"object {label} with greater than 70 percent confidence is detected")
								upload_image=True
